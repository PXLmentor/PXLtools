...
TOOLS = [
    ...
    {"label": "GLB Manager",   "icon": "icon_glb_importer.png",     "module": "PXLtools_GLB_Manager",
    ...
    {"label": "Materials",     "icon": "icon_arnold_material.png",  "module": "PXLtools_PBR_Material",
    ...
    {"label": "Render Layers", "icon": "icon_render_layers.png",    "module": "PXLtools_Render_Layer_Creator",
